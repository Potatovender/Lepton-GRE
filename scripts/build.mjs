...
for (const asset of ["src/landing.js", "src/styles.css", "src/assets/lepton-logo.png"]) {
...
for (const asset of ["src/browser-preview-live.js", "src/styles.css", "src/assets/lepton-logo.png"]) {
